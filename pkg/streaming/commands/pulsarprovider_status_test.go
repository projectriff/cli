...
func TestPulsarProviderStatusOptions(t *testing.T) {
	table := rifftesting.OptionsTable{
		{
			Name: "invalid resource",
			Options: &commands.PulsarProviderStatusOptions{
...
func TestPulsarProviderStatusCommand(t *testing.T) {
...
`,
		},
		{
			...
			Args: []string{streamName},
			ExpectOutput: `
Pulsar provider "default/my-stream" not found
`,
			ShouldError: true,
		},
		{
			...
			WithReactors: []rifftesting.ReactionFunc{
				rifftesting.InduceFailure("get", "pulsarproviders"),
			},
			ShouldError: true,
		},
	}

	table.Run(t, commands.NewPulsarProviderStatusCommand)
}
