...
func TestInMemoryProviderStatusOptions(t *testing.T) {
	table := rifftesting.OptionsTable{
		{
			Name: "invalid resource",
			Options: &commands.InMemoryProviderStatusOptions{
...
func TestInMemoryProviderStatusCommand(t *testing.T) {
...
`,
		},
		{
			...
			Args: []string{streamName},
			ExpectOutput: `
InMemory provider "default/my-stream" not found
`,
			ShouldError: true,
		},
		{
			...
			WithReactors: []rifftesting.ReactionFunc{
				rifftesting.InduceFailure("get", "inmemoryproviders"),
			},
			ShouldError: true,
		},
	}

	table.Run(t, commands.NewInMemoryProviderStatusCommand)
}
