...
func TestKafkaProviderListOptions(t *testing.T) {
	table := rifftesting.OptionsTable{
		{
			Name: "invalid list",
			Options: &commands.KafkaProviderListOptions{
...
func TestKafkaProviderListCommand(t *testing.T) {
...
`,
		},
		{
			...
			ExpectOutput: `
NAME                  BOOTSTRAP SERVERS   PROVISIONER   STATUS      AGE
test-kafka-provider   <empty>             <empty>       <unknown>   <unknown>
`,
		},
		{
...
`,
		},
		{
			...
			ExpectOutput: `
NAMESPACE         NAME                        BOOTSTRAP SERVERS   PROVISIONER   STATUS      AGE
default           test-kafka-provider         <empty>             <empty>       <unknown>   <unknown>
other-namespace   test-other-kafka-provider   <empty>             <empty>       <unknown>   <unknown>
`,
		},
		{
			...
			GivenObjects: []runtime.Object{
				&streamv1alpha1.KafkaProvider{
					...
					Status: streamv1alpha1.KafkaProviderStatus{
						Status: apis.Status{
			...
			ExpectOutput: `
NAME       BOOTSTRAP SERVERS   PROVISIONER            STATUS   AGE
my-kafka   localhost:9092      my-kafka-provisioner   Ready    <unknown>
`,
		},
		{
			Name: "list error",
			...
			WithReactors: []rifftesting.ReactionFunc{
				rifftesting.InduceFailure("list", "kafkaproviders"),
			},
			ShouldError: true,
		},
	}

	table.Run(t, commands.NewKafkaProviderListCommand)
}
