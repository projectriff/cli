...
`),
	...
	_ = cmd.MarkFlagCustom(cli.StripDash(cli.ApplicationRefFlagName), "__riff_list_applications")
	cmd.Flags().StringVar(&opts.ContainerRef, cli.StripDash(cli.ContainerRefFlagName), "", "`name` of container to deploy")
	_ = cmd.MarkFlagCustom(cli.StripDash(cli.ContainerRefFlagName), "__riff_list_containers")
	cmd.Flags().StringVar(&opts.FunctionRef, cli.StripDash(cli.FunctionRefFlagName), "", "`name` of function to deploy")
	_ = cmd.MarkFlagCustom(cli.StripDash(cli.FunctionRefFlagName), "__riff_list_functions")
	...
	_ = cmd.MarkFlagCustom(cli.StripDash(cli.ConfigurationRefFlagName), "__kubectl_get_knative_configurations")
	cmd.Flags().StringVar(&opts.ServiceRef, cli.StripDash(cli.ServiceRefFlagName), "", "`name` of Knative service to update")
	_ = cmd.MarkFlagCustom(cli.StripDash(cli.ServiceRefFlagName), "__kubectl_get_knative_services")
