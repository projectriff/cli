...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Configurer) DeepCopyInto(out *Configurer) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Configurer.
func (in *Configurer) DeepCopy() *Configurer {
	if in == nil {
		return nil
	}
	out := new(Configurer)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *Configurer) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	} else {
		return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigurerList) DeepCopyInto(out *ConfigurerList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]Configurer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigurerList.
func (in *ConfigurerList) DeepCopy() *ConfigurerList {
	if in == nil {
		return nil
	}
	out := new(ConfigurerList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ConfigurerList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	} else {
		return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigurerSpec) DeepCopyInto(out *ConfigurerSpec) {
	*out = *in
	if in.Build != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigurerSpec.
func (in *ConfigurerSpec) DeepCopy() *ConfigurerSpec {
	if in == nil {
		return nil
	}
	out := new(ConfigurerSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigurerStatus) DeepCopyInto(out *ConfigurerStatus) {
	*out = *in
	in.Status.DeepCopyInto(&out.Status)
	if in.Address != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigurerStatus.
func (in *ConfigurerStatus) DeepCopy() *ConfigurerStatus {
	if in == nil {
		return nil
	}
	out := new(ConfigurerStatus)
	in.DeepCopyInto(out)
	return out
}
